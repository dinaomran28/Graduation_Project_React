...
function HomeAfterLogin() {
    ...
    const [ResturantDataHome, setResturantDataHome] = useState([]);
    const [CafesDataHome, setCafesDataHome] = useState([]);
    const [CulbesDataHome, setCulbesDataHome] = useState([]);
    const [PlacesDataHome, setPlacesDataHome] = useState([]);
    const [HotelsDataHome, setHotelsDataHome] = useState([]);
    ...
    useEffect(() => {
        ...
        axios.get("https://bakr-app.herokuapp.com/api/home")
            .then(res => {
                if (res.status) {
                    setPlacesDataHome(res.data.data.TouristPlace)
                    setCafesDataHome(res.data.data.Cafes)
                    setResturantDataHome(res.data.data.Restaurants)
                    setHotelsDataHome(res.data.data.Hotels)
                    setCulbesDataHome(res.data.data.club)
                }
            })
    })
        ...
        <>
            ...
            <div className="Home-page">
                <div className="head-page">
                    <h1 className="Title-head">HOME</h1>
                    ...
                    <section className="dest">
                        <div className="container">
                            ...
                            <div className="boxes resturant noactive  justify-content-between align-items-center flex-row flex-wrap">
                                {ResturantDataHome && ResturantDataHome.map((res, idx) => {
                                    return (
                                        <div key={idx} className="box p-3 shadow-sm" id={res.id}>
                                            {/* <img src={res.pic} className="img-fluid" alt="Imag"/> */}
                                            <h5 className="fs-5 mt-2"><b>Name : </b>{res.name}</h5>
                                ...
                                {CafesDataHome && CafesDataHome.map((res, idx) => {
                                    return (
                                        <div key={idx} className="box p-3 shadow-sm" id={res.id}>
                                            {/* <img src={res.pic} className="img-fluid" alt="Imag"/> */}
                                            <h5 className="fs-5 mt-2"><b>Name : </b>{res.name}</h5>
                            ...
                            <div className="boxes transport noactive  justify-content-between align-items-center flex-row flex-wrap">
                                {HotelsDataHome && HotelsDataHome.map((res, idx) => {
                                    return (
                                        <div key={idx} className="box p-3 shadow-sm" id={res.id}>
                                            {/* <img src={res.pic} className="img-fluid" alt="Imag"/> */}
                                            <h5 className="fs-5 mt-2"><b>Name : </b>{res.name}</h5>
                            ...
                            <div className="boxes club noactive  justify-content-between align-items-center flex-row flex-wrap">
                                {CulbesDataHome && CulbesDataHome.map((res, idx) => {
                                    return (
                                        <div key={idx} className="box p-3 shadow-sm" id={res.id}>
                                            {/* <img src={res.pic} className="img-fluid" alt="Imag"/> */}
                                            <h5 className="fs-5 mt-2"><b>Name : </b>{res.name}</h5>
