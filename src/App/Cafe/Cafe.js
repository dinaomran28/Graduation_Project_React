...
import "./Cafe.css";
import Pic1 from "./image/alsahabi lane.jpg"
import Pic2 from "./image/alsahabi lane1.jpg"
import Pic3 from "./image/alsahabi lane2.jpg"
import Pic4 from "./image/alsahabi lane3.jpg"
import Menu1 from "./image/alsahabi lan cafe menu0.jpg"
import Menu2 from "./image/alsahabi lan cafe menu1.jpg"
...
useEffect(()=>{
    async function fetchData() {
        await axios.get("https://bakr-app.herokuapp.com/api/cafe/getCafeById/62c32901c8323f05e0f83122").then(res=>{
        ...
        <div className="container-restaurant">
            <div className="offer-box-one d-flex gap-3 pb-5 ">
                <div className="offer-box-img">
                    <img src={Pic1} alt="Resturant_Img" />
                </div>
