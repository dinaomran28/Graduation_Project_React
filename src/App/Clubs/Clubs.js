...
import "./Clubs.css";
import Pic1 from "./image/family0.jpg"
import Pic2 from "./image/family1.jpg"
import Pic3 from "./image/family2.jpg"
import Pic4 from "./image/family3.jpg"
...
useEffect(()=>{
    async function fetchData() {
        await axios.get("https://bakr-app.herokuapp.com/api/clubs/getClubById/62841455c71b0c00161368c0").then(res=>{
...
<div className="offer">
        <div className="container-restaurant">
            ...
            <div className="text py-5">
                ...
                <p><b>City : </b>{ResturantData.City} <br/> <b>Price : </b>{ResturantData.Price}</p>
