...
import "./Tourist.css";
import Pic1 from "./image/Unfinished obelisk0.jpg"
import Pic2 from "./image/Unfinished obelisk1.jpg"
...
useEffect(()=>{
    async function fetchData() {
        await axios.get("https://bakr-app.herokuapp.com/api/tourist/getTouristById/62c0b2f21473b42948736471").then(res=>{
